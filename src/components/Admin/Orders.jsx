            ...
            <div className="bg-[#FBF8F3] rounded-xl px-5 py-4 mb-5 border border-[#DCCBBC] shadow-sm">
                <div className="flex justify-between items-center gap-4 max-sm:flex-col max-sm:items-start">
                    ...
                    <div className="flex items-center gap-3 max-sm:w-full">
                        <label className="text-sm text-[#5A4030]">
                            Search:
                        </label>
                        <input
                            type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search name, email or order ID"
                            className="border border-[#DCCBBC] rounded-lg px-4 py-3 bg-[#FBF8F3] text-[#5A4030] outline-none w-72 max-sm:w-full"/>
                    </div>
